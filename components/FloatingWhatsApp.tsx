...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      aria-label="Chat with 365 Tours on WhatsApp"
      title="Chat on WhatsApp"
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-green-900/30 ring-1 ring-black/5 transition hover:scale-105 hover:bg-[#20ba5a] active:scale-95 sm:bottom-6 sm:right-6"
    >
